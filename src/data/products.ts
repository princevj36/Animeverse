...
const keychainProducts: Product[] = [
  { id: 'kc1', name: 'Luffy Good Luck Keychain', description: 'One Piece Luffy keychain with "Good luck Best Wishes For You" strap.', price: 299, originalPrice: 449, images: keychainImage92, category: 'keychain', rating: 4.8, inStock: true, anime: 'One Piece' },
